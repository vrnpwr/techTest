        ...
        <div class="leftside-navigation">
            ...
            <li class="sub-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="link/add_quiz.php">CREATE QUESTION-PAPER</a></li>
                        <li><a href="link/view_quiz.php">VIEW QUESTION-PAPER</a></li>
                        <li><a href="link/edit_quiz.php">EDIT QUESTION-PAPER</a></li>
        ...
        if(mysqli_num_rows($run)){
          ...
          echo " <thead>
            ...
            while($row = mysqli_fetch_array($run)){
                ...
                echo "<td>".$row[1]."</td>";
                echo "<td>".$row[2]."</td>";
                echo "<td>"."<img src='$row[3]' height='100px' width='75px'>"."</td>";
                echo "<td>".$row[4]."</div></td>";
                echo "<td>".$row[5]."</td>";
            }
            echo "</tr>";
        echo "</table>";
